...
Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If TextReference.Text = Nothing Or TextQuantites.Text = Nothing Or ComboCategories.Text = Nothing Or TextAffectation.Text = Nothing Or TextZS.Text = Nothing Or ComboFournisseurs.Text = Nothing Or ComboFournisseurs.Text = Nothing Or TextRessources.Text = Nothing Or TextPrix.Text = Nothing Then
            MsgBox("Remplir tous les champs pour ajouté un article!")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If TextReference.Text = Nothing Or TextQuantites.Text = Nothing Or ComboCategories.Text = Nothing Or TextAffectation.Text = Nothing Or TextZS.Text = Nothing Or ComboFournisseurs.Text = Nothing Or ComboFournisseurs.Text = Nothing Or TextRessources.Text = Nothing Or TextPrix.Text = Nothing Then
            MsgBox("Remplir tous les champs pour modifé un article!")
